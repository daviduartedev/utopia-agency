## Context
Implementar componente de blur abaixo de cada seção, conforme prompt: 
## Integrate the <GradualBlur /> component from React Bits
...
Além disso, implementar no portfolio uma novo card com o print 'Site para Jogos Eletrônicos (CS2)'


## Intent

Ao final, no bottom de cada seção deve haver o componente de bottom, e também, um novo card no carrossel de portfolio
