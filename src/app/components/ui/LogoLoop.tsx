...
function useResizeObserver(
  callback: () => void,
  elementRefs: readonly RefObject<Element | null>[],
  deps: DependencyList
) {
  useEffect(() => {
    ...
    const observers = elementRefs.map((ref) => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- mirror react-bits deps contract
  }, [callback, ...deps]);
}
