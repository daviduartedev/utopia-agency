...
| 8 | Depoimentos | `Testimonials` (novo masonry) | Prova de experiência |
...
- **Primário**: WhatsApp. Botão branco, texto preto, ícone seta. Presente em Hero, Navbar, HowItWorks (BookCallWidget), Offer (um por card), CTA final, Footer e Floating button.
